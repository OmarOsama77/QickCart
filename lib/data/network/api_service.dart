...
class ApiService {
 ...
 Future<Products> getProductById(String pId)async{
   ...
   if(res.statusCode==200){
    ...
    Products product = Products(id: pro["id"], gender: pro["gender"], image_url: pro["image_url"], name: pro["name"], price: pro["price"], weight: pro["weight"]);
    return product;
   }
  return Products(id: 0, gender: 'gender', image_url: 'image_url', name: 'name', price: 2, weight: 'weight');
  }
