...
class BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:BlocBuilder<BottomNavBarCubit,BottomNavBarState>(builder:(_,state){
      ...
      bottomNavigationBar: BlocBuilder<BottomNavBarCubit,BottomNavBarState>(builder:(_,state){
        return BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem( icon: Icon(Icons.home, color: Color(0xFFDB3022),), label: 'Home'),
              BottomNavigationBarItem(icon: Icon(Icons.shopping_cart,color:Color(0xFFDB3022),), label: 'Cart'),
              BottomNavigationBarItem(icon: Icon(Icons.favorite,color:Color(0xFFDB3022),), label: 'Favorites'),
              BottomNavigationBarItem(icon: Icon(Icons.account_box_rounded,color:Color(0xFFDB3022),), label: 'Account'),
            ]);
      })
